    ...
    <header class="bg-cyan-600">
        <nav>
            ...
            <form method="GET" action="{{ route('search') }}" class="flex items-center space-x-2">
                <input type="text" name="query" value="{{ request('query') }}" placeholder="Search posts..." class="input flex-grow">
                <button type="submit" class="btn p-2 bg-cyan-600 text-white rounded-full">
